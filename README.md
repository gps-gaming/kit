# GoKit CLI  [![Build Status](https://travis-ci.org/gps-gaming/kit.svg?branch=master)](https://travis-ci.org/gps-gaming/kit)[![Go Report Card](https://goreportcard.com/badge/github.com/gps-gaming/kit)](https://goreportcard.com/report/github.com/gps-gaming/kit)[![Coverage Status](https://coveralls.io/repos/github/gps-gaming/kit/badge.svg?branch=master)](https://coveralls.io/github/gps-gaming/kit?branch=master)
I fork the project from [kit](https://github.com/gps-gaming/kit) and plan to maintain it in the future. The kit tool is a great job, and deeply used in our team. Some features and bugs have been done and fixed, such as supporting go module,replacing some old dependencies and so on. I am very glad to receive recommend about it.  

This project is a more advanced version of [gk](https://github.com/gps-gaming/gk).
